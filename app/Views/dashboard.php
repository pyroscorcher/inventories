...
<body class="bg-gray-100 min-h-screen">
    ...
    <aside class="fixed z-40 inset-y-0 left-0 w-64 bg-white shadow-lg flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            <h3 class="text-xs font-semibold text-gray-400 pt-4 pb-2">AKUN</h3>
            
            <a href="<?= base_url('logout') ?>" class="flex items-center p-3 text-sm text-gray-700 hover:bg-indigo-50">
