...
<head>
    ...
    <title>Edit Barang Gudang Material</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out lg:ml-64 p-4 lg:p-8">
        ...
        <!-- Edit Form Content (Wrapped in dashboard card style) -->
        <div class="bg-white p-6 rounded-xl shadow-lg dashboard-card-content">
            ...
            <form action="<?= base_url('products/update/'.$product['id']) ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="default_price" name="default_price" value="<?= $product['default_price'] ?>" required>
                </div>
